# FFA036 - Tarifario aéreo

## Descripción
FFA036 es un ABM de tarifas aéreas. Pertenece al sistema Fux.

## Build Commands

Build the solution using Visual Studio or MSBuild:
```bash
msbuild FFA036.sln /p:Configuration=Debug
```
...
- **FFA036N/** - Business logic library (VB.NET class library producing FFA036N.dll)
- **FFA036P/** - Web presentation layer (ASP.NET Web Forms website)
...
Files follow numeric naming convention `FFA036N###.vb`

### Presentation Layer (FFA036P)
...
Page naming convention: `[MODULE][NUMBER]P[PAGE].aspx` (e.g., `ABC902P002.aspx`, `FFA036P001.aspx`)
