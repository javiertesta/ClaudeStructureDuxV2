...
```bash
msbuild YNC207.sln /p:Configuration=Debug
```
...
- **YNC207N\** - Business logic library (VB.NET class library producing YNC207N.dll)
- **YNC207P\** - Web presentation layer (ASP.NET Web Forms website)
...
- Espacio de nombres ArmadoPdf contiene las clases de trabajo para la generación de PDFs.
- `itextsharp.dll` - DLL base para la generación de PDFs
- `Newtonsoft.Json.dll` - JSON serialization

### Business Logic Layer (YNC001N)

Files follow numeric naming convention `YNC207N###.vb`

### Presentation Layer (YNC207P)
...
Page naming convention: `[MODULE][NUMBER]P[PAGE].aspx` (e.g., `ABC902P002.aspx`, `YNC207P001.aspx`)
