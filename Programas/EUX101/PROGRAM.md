# EUX101 - ABM de operaciones HCAE (House Carga Aérea de Exportación)

## Descripción
EUX101 es uno de los tantos ABMs de operaciones de comercio exterior para forwarders. Específicamente este ABM es para cargas house (consolidadas o cargas directas) 
aéreas de exportación. Forma parte del sistema Fux, nuestro sistema de gestión para forwarders.

## Build Commands

Build the solution using Visual Studio or MSBuild:
```bash
msbuild EUX101.sln /p:Configuration=Debug
```
...
- **EUX101N\** - Business logic library (VB.NET class library producing EUX101N.dll)
- **EUX101P\** - Web presentation layer (ASP.NET Web Forms website)
...
Files follow numeric naming convention `EUX101N###.vb`

### Presentation Layer (EUX101P)
...
Page naming convention: `[MODULE][NUMBER]P[PAGE].aspx` (e.g., `ABC902P002.aspx`, `EUX101P001.aspx`)
